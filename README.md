...
1. setup your app as  
    ...
    heroku buildpacks:add https://github.com/platanus/heroku-buildpack-tesseract
    ```
...
## Note
This fork solves the [issue](https://github.com/fouady/RoR-Tesseract-Heroku/issues/1) of the missing libraries `libtiff4` and `libjpeg62` and the location of tessdata.
